insert into match (id, datetime, stadium, foreigners, hosts) values (1, current_timestamp, 'Wembley Stadium', 1,10);
insert into match (id, datetime, stadium, foreigners, hosts) values (2, current_timestamp, 'Santiago Bernabeu', 2,9);
